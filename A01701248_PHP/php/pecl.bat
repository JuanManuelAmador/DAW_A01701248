...
FOR %%x IN ("C:\Users\Pepus Perez Flores\Documents\DAW_A01701248\A01701248_PHP\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Users\Pepus Perez Flores\Documents\DAW_A01701248\A01701248_PHP\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Users\Pepus Perez Flores\Documents\DAW_A01701248\A01701248_PHP\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Users\Pepus Perez Flores\Documents\DAW_A01701248\A01701248_PHP\php\php.exe"
GOTO :INSTALLED
