...
if "%PHPBIN%" == "" set PHPBIN=C:\Users\Pepus Perez Flores\Documents\DAW_A01701248\A01701248_PHP\php\.\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "C:\Users\Pepus Perez Flores\Documents\DAW_A01701248\A01701248_PHP\php\phpunit" %*
